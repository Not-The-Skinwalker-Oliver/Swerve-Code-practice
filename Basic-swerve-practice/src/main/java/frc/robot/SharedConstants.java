...
public final class SharedConstants {
  ...
  public static final class DrivebaseConstants {
    ...
    /** Meters per Second */
    public static final double MAX_SPEED = 1; // TODO: This must be tuned to specific robot
    /** Radians per Second */
    ...
    public static final class MOD_0 { // TODO: This must be tuned to specific robot
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(95.064);
    ...
    public static final class MOD_1 { // TODO: This must be tuned to specific robot
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(263.408);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(
    ...
    public static final class MOD_2 { // TODO: This must be tuned to specific robot
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(321.503);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(
